...
namespace MyLeasing.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Brandon", "Vargas", "brandon.v179@gmail.com", "350 634 2747", "Calle Luna Calle Sol", "Manager");
            var owner = await CheckUserAsync("2020", "Brandon", "Vargas", "brandon.vargas1095@hotmail.com", "350 634 2747", "Calle Luna Calle Sol", "Owner");
            var lessee = await CheckUserAsync("3030", "Brandon", "Vargas", "brandon.vargas1095@outlook.com", "350 634 2747", "Calle Luna Calle Sol", "Lessee");
